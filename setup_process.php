...
$xfiles = "$way_of_the_fight/config.php"; // Construction du nom du fichier
		...
		if(mysqli_multi_query($connexion, $sql)){
			...
			// Creation du fichier config.php
				...
				$smartimprovment .= "\$payant_only_end_of_tunel = false; // Inscription normale mais validation Paypal (True écrasera la variable payant_only)"."\n\n";
				...
				$htaccess2k .="RewriteRule ^nouveautes.html index.php?act=last [QSA,L]"."\n\n";
