  ...
  paypal.Buttons({
	...
	createOrder: function(data, actions) {
	  return actions.order.create({
		purchase_units: [{"description":"Validation Express <?php echo $titre_annuaire; ?> | Ref. <?php echo $id; echo $refpaypal; ?>","amount":{"currency_code":"EUR","value":59.60,"breakdown":{"item_total":{"currency_code":"EUR","value":49.67},"shipping":{"currency_code":"EUR","value":0},"tax_total":{"currency_code":"EUR","value":9.93}}}}]
	  });
	},
